...
public class AffichageCartelPanel extends JPanel{
     ...
     private void CreateLayout()
    {
        ...
        final JTable tableGis = new JTable(gisData, gisColumns);
        final JTable tableInfo = new JTable(infosData, infosColumns);
        final JTable tableProd = new JTable(prodData, prodColumns);
        final JTable tableCies = new JTable(ciesData, ciesColumns);
